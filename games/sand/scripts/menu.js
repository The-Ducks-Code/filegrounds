...
const elementMenuItems = [
  WALL, METAL_WALL, SAND, WATER, PLANT,
  FIRE, SPOUT, WELL, SALT,
  OIL, WAX, TORCH, ICE,
  GUNPOWDER, NAPALM, NITRO, C4,
  LAVA, CRYO, FUSE, MYSTERY,
  CONCRETE, METHANE, SOIL, POLLEN, NUCLEAR_FLUID, STEAM, BRANCH, LEAF, CHARGED_NITRO, ROCK, STEAMER, VIRUS, BACKGROUND
];

const menuNames = {};
menuNames[WALL] = "WALL";
menuNames[METAL_WALL] = "METAL WALL";
menuNames[SAND] = "SAND";
...
menuNames[NUCLEAR_FLUID] = "NUCLEAR FLUID";
menuNames[STEAM] = "STEAM";
menuNames[BRANCH] = "BRANCH";
menuNames[LEAF] = "LEAF";
menuNames[CHARGED_NITRO] = "CHARGED NITRO";
menuNames[ROCK] = "ROCK";
menuNames[STEAMER] = "STEAMER";
menuNames[VIRUS] = "VIRUS";
